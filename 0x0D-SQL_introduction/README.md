...
In this project, we starting with introduction into Structured Query Language which is under relationl databases. I started practising SQL data definitions and data manipulation language, making subqueries, and using functions.
